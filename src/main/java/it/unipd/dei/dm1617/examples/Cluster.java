...
import static it.unipd.dei.dm1617.examples.Cluster.doClustering;
...
public class Cluster {
     ...
     */
    // just a stub in order to be able to call this class from another one
    public static void main(String[] args){
        ...
        doClustering(sc, args[0], args[1], Integer.parseInt(args[2]), Integer.parseInt(args[3]));
    }

    public static void doClustering(JavaSparkContext sc, String dataset, String clusteringName, int numClusters, int numIterations){
