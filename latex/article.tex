...
Successivamente il capitolo \ref{sec:rappresentazione} descrive le tecniche utilizzate per rappresentare il dataset.
...
\section{Clustering} \label{sec:clustering}
	...
	\subsection{Tecniche di Clustering}
		...
		\subsubsection{Latent Dirichlet Allocation}
			...
			\end{tabular}
			\caption{Alcuni topic individuati da LDA con i termini associati pi\`{u} rilevanti}
...
\section{Risultati} \label{sec:results}
	...
	\subsection{Confronto tra i cluster e categorie con Normalized Mutual Information} \label{sec:NMI-confronto}
