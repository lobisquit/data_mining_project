...
\section{Dataset e Analisi Preliminare}
    ...
    \begin{figure}[!htb]
		\hspace{-4.5cm}
			...
			\centering
			\includegraphics[scale=.5]{categoriesCake.png}
			\end{subfigure}
		\hspace{0.5cm}
			\begin{subfigure}{.5\textwidth}
			\centering
			\includegraphics[scale=.5]{categories.png}
			\end{subfigure}
	...
	\subsection{Validazione con Simplified Silhouette}
		...
		\begin{figure}[!htb]
			\hspace{-1cm}
				\begin{subfigure}{.5\textwidth}
				\centering
				\includegraphics[scale=.5]{simplifiedSilhouette.eps}
				\end{subfigure}
			\hspace{0.5cm}
				\begin{subfigure}{.5\textwidth}
				\centering
				\includegraphics[scale=.5]{simplifiedSilhouetteDerivative.eps}
				\end{subfigure}
